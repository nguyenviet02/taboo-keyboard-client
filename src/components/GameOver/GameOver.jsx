...
export default function GameOver({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="bg-linear-to-br from-slate-800 to-slate-900 rounded-2xl p-6 md:p-8 w-full max-w-md shadow-2xl border border-slate-700 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-linear-to-r from-pink-500 to-rose-400 bg-clip-text text-transparent">
          Game Over
        </h1>
        ...
        <div className="flex justify-center gap-8 mb-6">
          <div className="text-center">
            ...
            <span className="block text-4xl font-bold text-pink-400">
              {roundsCleared}
            </span>
          </div>
        ...
        {!passedRound1 ? (
          <div className="mb-6 p-4 bg-slate-700/50 rounded-xl">
            <div className="text-xl font-bold text-gray-400 mb-1">No Rank</div>
          ...
          <div className="mb-6 p-4 bg-slate-700/50 rounded-xl">
            <div className="text-xl font-bold text-gray-400 mb-1">Rank 50+</div>
            <div className="text-sm text-gray-500">
        ...
        <div className="flex flex-col gap-3">
          <button
            onClick={onPlayAgain}
            className="w-full py-3 text-lg font-bold border-none rounded-lg bg-linear-to-r from-pink-500 to-rose-400 text-white cursor-pointer hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-500/30 transition-all"
          >
            Play Again
          </button>
