...
export default function Home({ onStartGame, onViewLeaderboards }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-linear-to-br from-slate-900 to-slate-800 text-white">
      <h1 className="text-5xl font-bold mb-4 bg-linear-to-r from-pink-500 to-rose-400 bg-clip-text text-transparent">
        Taboo Keyboard
      </h1>
      ...
      >
        ...
        <button
          type="submit"
          className="py-3 px-6 text-xl font-bold border-none rounded-lg bg-linear-to-r from-pink-500 to-rose-400 text-white cursor-pointer hover:-translate-y-0.5 hover:shadow-lg hover:shadow-pink-500/30 transition-all active:translate-y-0"
        >
          Start Game
        </button>
